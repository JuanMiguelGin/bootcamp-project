...
> Añade aquí la URL de Vercel cuando despliegues la app.
...
### Wireframe / Captura de diseño

> Guarda una imagen en `docs/design/` y enlázala aquí.
...
1. Clona el repositorio:
   ...
   ```
2. Abre `index.html` con Live Server (extensión de VS Code) o directamente en el navegador.
